...
if __name__ == '__main__':
    ...
    if training:
        ...
        for epoch in range(args.num_epochs):
            ...
            p1, p5 = validate(val_dataloader, image_model, text_model, args.anchor, epoch, 'validation')
            wandb.log({
                "epoch": epoch,
                "p1": p1,
                "p5": p5,
        ...
        state_dict =  torch.load('{}/models/{}_weights.pth'.format(output_path,args.anchor))
